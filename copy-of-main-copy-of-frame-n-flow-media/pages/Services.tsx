      ...
      <AnimatePresence mode='wait'>
        ...
        {activeTab === 'marketing' && (
          ...
          >
            ...
            {/* AI STUDIO MARKETING VISUALS PORTFOLIO */}
            <div className="py-12 border-t border-white/5 relative z-10">
              <div className="text-center mb-10">
                <span className="text-accent uppercase tracking-widest text-[10px] font-bold mb-3 block">AI Studio Marketing Visuals</span>
                <h3 className="text-2xl md:text-4xl font-display font-bold text-white mb-4">Our Creative Production Portfolio</h3>
                <p className="text-sm text-white/50 max-w-xl mx-auto font-light leading-relaxed">
                  Stunning, high-conversion visual creatives composed by our generative AI engines for high-end digital marketing and lifestyle campaigns.
                </p>
              </div>

              {/* Compact 3-column kinetic/reels showcase */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  {
                    url: "https://www.instagram.com/reel/DN2Gtyy6lQb/embed",
                    title: "Luxury Product Showcase",
                    description: "High-fidelity photorealistic light and physics simulation for luxury products."
                  },
                  {
                    url: "https://www.instagram.com/reel/DSkyKTyE-mM/embed",
                    title: "Digital Fashion Reel",
                  ...
                  <FadeIn key={index} delay={index * 0.1} className="flex flex-col h-full">
                    <div className="bg-[#121212] border border-white/10 rounded-2xl overflow-hidden shadow-2xl relative group h-full flex flex-col hover:border-accent/40 transition-all duration-300">
                      ...
                      <div className="p-5 border-t border-white/5 bg-surfaceHighlight flex-1">
                ...
                {[
                  ...
                  <FadeIn key={index} delay={index * 0.1} className="flex flex-col h-full">
                    <div 
                      ...
                      className="bg-[#121212] border border-white/10 rounded-2xl overflow-hidden shadow-2xl relative group h-full flex flex-col hover:border-emerald-500/40 transition-all duration-300 cursor-pointer"
                    >
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between">
                        <div>
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-xs font-mono text-emerald-400 uppercase tracking-wider">{item.tech[0]}</span>
