...
export const routes: RouteObject[] = [
    ...
    { path: '/services', element: <Services tab="selection" /> },
    { path: '/services/marketing', element: <Services tab="marketing" /> },
    { path: '/services/website-development', element: <Services tab="webdev" /> },
    { path: '/services/ai-automation', element: <Services tab="automation" /> },
